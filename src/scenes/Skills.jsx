    ...
    >
      ...
      <div className='flex flex-col justify-center items-center md:gap-16 mt-32'>
        ...
        >
          ...
          <p className='mt-10 mb-7 w-[380px]'>A list of my current skills which I belive will provide value to you. Not limited, and continously learning..</p>
          </div>
        </motion.div>
      </div>
      ...
      <p className='font-playfair font-semibold text-4xl mb-5'>
        ...
        <p className='mt-1 w-[325px]'>A strong work ethic that has consistently led to exceptional performance in all job duties.</p>
      ...
      <div className='flex justify-center items-center mt-5 gap-8'>
        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className="w-[50px] h-[50px] " src={mongodb}/>
          <p>MongoDB</p>
        </div>

        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className="w-[50px] h-[50px] hover:w-[80px] " src={expressjs }/>
          <p>EspressJs</p>
        </div>

        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className='w-[50px] h-[50px]' src={reactjs}/>
          <p>ReactJS</p>
        </div>
        
        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className="w-[50px] h-[50px]" src={nodejs}/>
          <p>NodeJs</p>
        </div>
        </div>
        ...
        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className="w-[50px] h-[50px]" src={tailwind}/>
          <p>Tailwind</p>
        </div>
        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className="w-[50px] h-[50px]" src={css}/>
          <p>CSS</p>
        </div>
        <div className='flex flex-col items-center h-[50px] w-[50px] hover:scale-110 hover:opacity-70  transition duration-300'>
          <img className="w-[50px] h-[50px]" src={photoshop}/>
          <p>Photoshop</p>
        </div>
        </div>
